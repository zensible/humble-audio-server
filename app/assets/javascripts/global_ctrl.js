...
multiroomApp.controller('GlobalCtrl', function ($scope, $routeParams, $route, $http, $rootScope) {
  ...
  // For use when we need to update angular based on a non-angular (e.g. jquery) browser event
  ...
  // When something goes haywire on the rails side, show nice notifyjs error message if there is one, or a default one if not
